...
endS = 19*19
incS = 3
l_ = [40,91,160,247,352]#[4*4,5*5,6*6,7*7,8*8]#[10*10,12*12,14*14] #,16*16,18*18,20*20]
for ite in l_:#range(startS,endS,incS):	
    ...
    swift_uclr_g_v_opt = np.loadtxt(f"pyplotfiles/swift_ucrlg_v_opt_{ite}_{nA}.txt", delimiter=" ")
    swift_uclr_g_v_pol = np.loadtxt(f"pyplotfiles/swift_ucrlg_v_pol_{ite}_{nA}.txt", delimiter=" ")
    swift_uclr_g_v_pol_e = np.loadtxt(f"pyplotfiles/swift_ucrlg_v_pol_e{ite}_{nA}.txt", delimiter=" ")
    swift_uclr_g_v_opt_e = np.loadtxt(f"pyplotfiles/swift_ucrlg_v_opt_e{ite}_{nA}.txt", delimiter=" ")
    print(swift_uclr_g_v_opt.shape)
    plot([swift_uclr_g_v_opt, swift_uclr_g_v_pol], ["V_star", "V"], y_label="Learned Value over time", exp_name=f"swiftUCLR_Gamma Value over time{ite}_{nA}")
    plot([swift_uclr_g_v_opt_e, swift_uclr_g_v_pol_e], ["Expected_V_star", "Expected_V"], y_label="Learned Value over time", exp_name=f"swiftUCLR_Gamma Expected Value over time{ite}_{nA}")
